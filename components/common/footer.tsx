...
export default function Footer() {
    return (
        <>
            <div className="w-full justify-center flex items-center flex-col gap-4 bg-main-1 text-white sm:px-4 sm:py-4 pt-16 pb-8 mt-4 min-h-[20rem] border-t-1 border-main-2">
