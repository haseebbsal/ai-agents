...
export default function PolicyForm({ imgSrc, agentInfo, agentText, agent }: AgentFormInteface) {
    ...
    return (
        <>
                    ...
                    <div className="flex flex-1 flex-wrap gap-4 w-full sm:p-0 p-4">
                        ...
                        <form onSubmit={handleSubmit(agentSubmit)} className=" flex-1  flex flex-col gap-4 p-4 border-2 rounded-lg border-main-2  mt-4 sm:mr-4 mb-4">
                            ...
                            <div className="flex flex-col gap-4">
                                <BaseFile accept=".pdf,.docx,.txt" headerText="Upload Policy PDF" showHeader={true} control={control} name="agent" rules={{ required: "Select File" }} />
                            </div>
            ...
            {chatFile && <div className="flex-1  flex flex-col gap-4 p-4 border-2 h-[80vh]  rounded-lg border-main-2  mt-4 mr-4 ml-4  mb-4">
