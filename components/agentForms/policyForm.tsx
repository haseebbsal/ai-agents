...
export default function PolicyForm({ imgSrc, agentInfo, agentText, agent }: AgentFormInteface) {
    ...
    return (
        <>
            {!chatFile && <form onSubmit={handleSubmit(agentSubmit)} className=" flex-1 ml-4 flex flex-col gap-4 p-4 border-2 rounded-lg border-main-2  mt-4 sm:mr-4 sm:ml-0 mr-4 ml-4 mb-4">
